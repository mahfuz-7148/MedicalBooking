        ...
        <div className='mx-2 mb-10'>
            ...
            <div className='p-15 bg-white shadow-lg rounded-3xl mx-auto mt-6'>
                ...
                <div className='md:flex justify-between items-center'>
                    ...
                    <h1 className='md:badge md:badge-outline text-[#FFA000] text-lg bg-[#FFA0001A] md:p-4 font-semibold rounded-lg md:rounded-full'><i class="ri-error-warning-line "></i> Due to high patient volume, we are currently accepting appointments for today only. We appreciate your understanding and cooperation.</h1>
